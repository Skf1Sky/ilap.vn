              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-800 font-medium">53 Chu Mạnh Trinh Đà Nẵng (Vui lòng gọi trước khi đến)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-800 font-medium text-lg tracking-wider">0909 909 619</p>
                  </div>
                </div>
              </div>
            </div>
